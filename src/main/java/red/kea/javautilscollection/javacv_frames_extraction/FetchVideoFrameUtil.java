package red.kea.javautilscollection.javacv_frames_extraction;
...
public class FetchVideoFrameUtil {
    ...
    public static void main(String[] args){
        try {
            String picPath = "D:\\video\\pic\\";  // 提取得每帧图片存放位置
            String videoPath = "D:\\video\\t.mp4";  // 原视频文件路径
