package red.kea.javautilscollection.picture_utils;

/**
 * 功能描述: 图片处理工具类 功能 等比例缩放 裁切 加水印 复合操作
 * <p>
 * 版权所有：杭州立方控股
 * <p>
 * 未经本公司许可，不得以任何方式复制或使用本程序任何部分
 *
 * @author zliang 新增日期：2019-04-01
 * @author zliang 修改日期：2019-04-01
 * @version 1.0.0
 * @since 1.0.0
 */
...
public class ImageUtils {
    ...
    public static void main(String[] args) {
        // 1.等比例缩放
//         scaleNormal("D:\\BBBB\\a.jpg", "D:\\BBBB\\scaleNormal.jpg", 720,
//         1080);
        // 2.等比例缩放加水印
        // scaleWithWaterMark("D:\\img\\src.jpg",
        // "D:\\img\\scaleWithWaterMark.jpg",720, 1080);
        // 3.缩放到指定宽度
         scaleWithWidth("D:\\BBBB\\a.jpg", "D:\\BBBB\\aalibababa.jpg",
         720);
        // 4.缩放到指定高度
